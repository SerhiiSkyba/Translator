...
def test(x):
    ...
    if x == wylosowane_slowo_en.get():
        ...
        my_imagem = ctk.CTkImage(Image.open(folder+"\Images\\"+str(wylosowane_slowo_en.get())+'.jpg'),size = (300,300))
        image_labelm = ctk.CTkLabel(windowm, image=my_imagem, text = "")
        labelm = ctk.CTkLabel(windowm,font=("Comic Sans MS",23,'bold','italic'),bg_color="#0b703f",text = " To jest "+str(wylosowane_slowo_pl.get())+", po angielsku to bedzie "+str(wylosowane_slowo_en.get()))
        image_labelm.pack()
        labelm.pack()
        windowm.mainloop()
...
btn1 = ctk.CTkButton(btnf1,textvariable=odpA,width=300,height=80,fg_color="#3b278c",command=lambda:test(odpA.get())) 
btn2 = ctk.CTkButton(btnf1,textvariable=odpB,width=300,height=80,fg_color="#311f7a",command=lambda:test(odpB.get())) 
btn3 = ctk.CTkButton(btnf2,textvariable=odpC,width=300,height=80,fg_color="#311f7a",command=lambda:test(odpC.get()))  
btn4 = ctk.CTkButton(btnf2,textvariable=odpD,width=300,height=80,fg_color="#3b278c",command=lambda:test(odpD.get())) 
btn5 = ctk.CTkButton(btnf3,textvariable=odpE,width=300,height=80,fg_color="#3b278c",command=lambda:test(odpE.get())) 
btn6 = ctk.CTkButton(btnf3,textvariable=odpF,width=300,height=80,fg_color="#311f7a",command=lambda:test(odpF.get())) 
